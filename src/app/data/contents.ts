...
const oshinContents: Content[] = [
  {
    page: "Home",
    title: "Oshin",
    description: `"With a passion to grow as a web developer, the journey is not only about building web applications, but also about becoming a better version of myself while helping others develop and grow together."`
  },
  {
    page: "About",
    title: "Oshin",
